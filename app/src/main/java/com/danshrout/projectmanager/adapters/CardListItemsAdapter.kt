...
import com.danshrout.projectmanager.models.SelectedMembers
...
open class CardListItemsAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            // For label color, make View Item visible and set the selected label color.
            ...
            // Public list of Assigned members detail List populate the recyclerView for Assigned Members.
    ...
    // OnClickListener where the Interface is the expected parameter.
